...
def ratio_of_longest_chain_vs_total_blocks_in_longest_chain(total_nodes=100, ttx_time=5000, blk_time=600000, blk_limit=100, 
    ...
    malicious_fractions = [0.05 * i for i in range(1, 21)]
    ...
    for eclipse in [0, 1]:
        for malicious in malicious_fractions:
            for _ in range(iters):
                ...
                ratio_blocks_to_total_main_chain[eclipse][int(malicious * 20) - 1] += stats["ratio_blocks_to_total_main_chain"]/iters
                ratio_blocks_to_generated[eclipse][int(malicious * 20) - 1] += stats["ratio_blocks_to_generated"]/iters
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('ratio_blocks_to_total_main_chain.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('ratio_blocks_to_generated.png')
    plt.close()
